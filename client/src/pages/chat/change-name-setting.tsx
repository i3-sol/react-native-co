...
const ChangeChatNameSetting = ({ navigation }: ComPropsObject) => {

    const onGoToSetting = () => navigation.navigate(routerConfig.setting.name)
    const [value, setValue] = React.useState('東京スイーツ部');
...
const ChangeChatNameSettingWrapper = styled(View)(({ theme }) => ({
