...
const DeleteModal = (props: DeleteModalProps) => {
    ...
    return (
        ...
        >
            <ModalTextContainer>
                <TextH4 style={{ fontWeight: 700, paddingBottom: getHeight(1) }}>全てのメッセージと写真、動画を削除しますか？</TextH4>
            </ModalTextContainer>
            <ButtonContainer>
                <Pressable onPress={() => setIsModal({ ...isModal, isDelete: false })}>
