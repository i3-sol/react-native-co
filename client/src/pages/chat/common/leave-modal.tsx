...
const LeaveModal = (props: LeaveModalProps) => {
    ...
    return (
        ...
        >
            <ModalTextContainer>
                <TextH4 style={{ fontWeight: 700, paddingBottom: getHeight(1), textAlign: 'center' }}>このトークを退出しますか？</TextH4>
            </ModalTextContainer>
            <ButtonContainer>
                <Pressable onPress={() => setIsModal({ ...isModal, isLeave: false })}>
